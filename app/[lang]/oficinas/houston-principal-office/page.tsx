...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede Principal de Houston', en: 'Our Houston Main Office' },
    subtitle: { 
      es: 'Información detallada, servicios y el equipo legal a su disposición en Houston, TX.', 
      en: 'Detailed information, services, and the legal team at your disposal in Houston, TX.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE HOUSTON (MAIN) ---
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE HOUSTON (NORMAL) ---
