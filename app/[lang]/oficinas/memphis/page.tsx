...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede de Memphis', en: 'Our Memphis Location' },
    subtitle: { 
      es: 'Información detallada, servicios y el equipo legal a su disposición en Memphis, TN.', 
      en: 'Detailed information, services, and the legal team at your disposal in Memphis, TN.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE MEMPHIS ---
const memphisData: OfficeData = {
  id: 'memphis',
  city: 'Memphis',
  state: 'TN',
  ...
  videoUrl: undefined, // No video for Memphis
  services: [
...
export default function MemphisOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = memphisData;
