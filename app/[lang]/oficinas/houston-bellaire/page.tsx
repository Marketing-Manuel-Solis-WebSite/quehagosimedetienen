...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede de Houston Bellaire', en: 'Our Houston Bellaire Location' },
    subtitle: { 
      es: 'Información detallada, servicios y el equipo legal a su disposición en Bellaire, Houston.', 
      en: 'Detailed information, services, and the legal team at your disposal in Bellaire, Houston.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE HOUSTON BELLAIRE ---
const bellaireData: OfficeData = {
  id: 'bellaire',
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE HOUSTON BELLAIRE ---
export default function BellaireOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = bellaireData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='bellaire-office'>
