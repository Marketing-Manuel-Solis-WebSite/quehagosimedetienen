...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede de Arvada', en: 'Our Arvada Location' },
    subtitle: { 
      es: 'Información detallada, servicios y el equipo legal a su disposición en el área de Denver, CO.', 
      en: 'Detailed information, services, and the legal team at your disposal in the Denver, CO area.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE ARVADA ---
const arvadaData: OfficeData = {
  id: 'arvada',
  city: 'Arvada',
  state: 'CO',
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE ARVADA ---
export default function ArvadaOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = arvadaData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='arvada-office'>
