...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede Northchase', en: 'Our Northchase Location' },
    subtitle: { 
      es: 'Asesoría legal experta y atención personalizada en el norte de Houston.', 
      en: 'Expert legal advice and personalized attention in North Houston.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE HOUSTON (NORTHCHASE) ---
const houstonNorthData: OfficeData = {
  ...
  mapLink: 'https://maps.app.goo.gl/s3zDpAmWvfZQdFt7A', // Puedes actualizar esto con el link exacto de Google Maps si lo tienes
  
  // CONFIGURACIÓN DE MEDIA
  videoUrl: undefined, 
  imageUrl: '/offices/ofNorth.png', // <--- IMAGEN DEFINIDA AQUÍ
  ...
  managers: [], // Se deja vacío si no hay gerente específico, la lógica lo oculta
  attorneys: [
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE HOUSTON NORTHCHASE ---
export default function HoustonNorthchaseOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = houstonNorthData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='houston-northchase'>
