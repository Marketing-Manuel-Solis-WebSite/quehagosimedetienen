...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede de Harlingen', en: 'Our Harlingen Location' },
    subtitle: { 
      es: 'Información detallada, servicios y el equipo legal a su disposición en Harlingen, TX.', 
      en: 'Detailed information, services, and the legal team at your disposal in Harlingen, TX.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE HARLINGEN ---
const harlingenData: OfficeData = {
  id: 'harlingen',
  city: 'Harlingen',
  state: 'TX',
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE HARLINGEN ---
export default function HarlingenOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = harlingenData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='harlingen-office'>
