...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede en Downtown Houston', en: 'Our Downtown Houston Location' },
    subtitle: { 
      es: 'Ubicación central y accesible para todos sus trámites legales en el corazón de Houston.', 
      en: 'Central and accessible location for all your legal proceedings in the heart of Houston.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE HOUSTON (MAIN ST) ---
const houstonMainData: OfficeData = {
  id: 'houston-main',
  city: 'Houston',
  state: 'TX',
  ...
  videoUrl: undefined, 
  imageUrl: '/offices/main.png', // <--- IMAGEN DEFINIDA AQUÍ
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE HOUSTON MAIN ST ---
export default function HoustonMainOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = houstonMainData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='houston-main'>
