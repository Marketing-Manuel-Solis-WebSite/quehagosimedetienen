...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede North Loop', en: 'Our North Loop Location' },
    subtitle: { 
      es: 'Ubicación estratégica y asesoría legal experta en el área de North Loop, Houston.', 
      en: 'Strategic location and expert legal advice in the North Loop area, Houston.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE HOUSTON (NORTH LOOP) ---
const houstonLoopData: OfficeData = {
  ...
  videoUrl: undefined, 
  imageUrl: '/offices/ofLoop.png', // <--- IMAGEN DEFINIDA AQUÍ
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE HOUSTON NORTH LOOP ---
export default function HoustonNorthLoopOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = houstonLoopData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='houston-north-loop'>
