...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede de Los Angeles', en: 'Our Los Angeles Location' },
    subtitle: { 
      es: 'Información detallada, servicios y el equipo legal a su disposición en Los Angeles, CA.', 
      en: 'Detailed information, services, and the legal team at your disposal in Los Angeles, CA.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE LOS ANGELES ---
const losAngelesData: OfficeData = {
  id: 'los-angeles',
  city: 'Los Angeles',
  state: 'CA',
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE LOS ANGELES ---
export default function LosAngelesOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = losAngelesData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='los-angeles-office'>
