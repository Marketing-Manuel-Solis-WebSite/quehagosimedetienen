...
import { MapPin, Phone, Clock, Star, CheckCircle2, Play, X, Globe } from 'lucide-react';
...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede Virtual en Houston', en: 'Our Houston Virtual Location' },
    subtitle: { 
      es: 'Atención digital personalizada con el respaldo físico de nuestra sede en Kirby Dr.', 
      en: 'Personalized digital attention backed by our physical location on Kirby Dr.' 
    },
  },
  contact: {
    address: { es: 'Dirección (Sede Base)', en: 'Address (Home Base)' },
    phone: { es: 'Teléfono', en: 'Phone' },
    hours: { es: 'Horario', en: 'Hours' },
    viewOnMap: { es: 'Ver en mapa', en: 'View on map' },
    servicesTitle: { es: 'Servicios Disponibles', en: 'Available Services' },
  ...
  form: {
    ...
    callback: { es: 'Llene este formulario y un asesor se pondrá en contacto con usted a la brevedad.', en: 'Fill out this form, and an advisor will contact you shortly.' }
  }
};

// --- DATA ESPECÍFICA DE HOUSTON (KIRBY DR) ---
const houstonData: OfficeData = {
  id: 'houston-virtual',
  city: 'Houston',
  state: 'TX',
  ...
  description: { 
    es: 'El Abogado de Inmigración Manuel Solís le guía en su trámite de visa humanitaria: visa U, visa VAWA, visa T, visa juvenil, permiso de trabajo y residencia permanente en USA. Contamos con representación legal en todo Estados Unidos y también ofrecemos asesoría en áreas legales como derecho familiar, accidentes, negligencia médica, derecho civil y criminal. Nuestro equipo de más de 200 profesionales analiza cada situación de manera detallada, elaborando estrategias legales personalizadas.', 
    en: 'Immigration Attorney Manuel Solís guides you through your humanitarian visa process: U visa, VAWA visa, T visa, juvenile visa, work permit, and permanent residency in the USA. We have legal representation throughout the United States and also offer advice in legal areas such as family law, accidents, medical malpractice, civil and criminal law. Our team of over 200 professionals analyzes each situation in detail, developing personalized legal strategies.' 
  },
  ...
  videoUrl: undefined, 
  imageUrl: '/offices/ofhouston.png', // <--- AQUÍ SE DEFINE LA IMAGEN (Ruta desde /public)
  ...
  services: [
    ...
    { es: 'ACCIDENTES Y NEGLIGENCIA', en: 'ACCIDENTS & MALPRACTICE' },
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE HOUSTON VIRTUAL ---
export default function HoustonVirtualOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = houstonData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='houston-office'>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-8 pt-8 md:pt-12">
                        ...
                        >
                            <Globe size={14} className="text-[#002342]" />
                            <span className="text-xs font-bold text-[#002342] tracking-wider uppercase">Sede Virtual / Online Hub</span>
                        </motion.div>
                        <motion.h2 
                            initial={{ opacity: 0, y: -20 }}
                            animate={{ opacity: 1, y: 0 }}
                            ...
                            <div className="relative h-[250px] md:h-[450px] w-full bg-[#002342] overflow-hidden group">
                                ...
                                {activeOffice.videoUrl ? (
                                    ...
                                    <div className="relative w-full h-full">
                                        ...
                                        {/* Overlay Gradient para que se lea el texto */}
                                        <div className="absolute inset-0 bg-gradient-to-t from-[#002342] via-[#002342]/50 to-transparent opacity-90 md:opacity-80" />
                                    </div>
                                )}
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-5 md:p-12 text-white z-10">
                                    ...
                                    >
                                        <div className="flex flex-wrap items-center gap-2 mb-2">
                                            ...
                                            <span className="bg-white/20 backdrop-blur-md text-white text-[10px] md:text-xs font-bold px-2 py-1 rounded-full uppercase tracking-wider shadow-md">
                                                VIRTUAL OFFICE
                                            </span>
                                        </div>
                                        ...
                                        <h4 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                                            {t('form.request').split(' ').map((word, index) => (
                                                <React.Fragment key={index}>
                                                    {word === 'CONSULTA' || word === 'CONSULTATION' ? 
