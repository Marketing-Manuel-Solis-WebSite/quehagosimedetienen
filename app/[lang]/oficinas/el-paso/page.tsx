...
const interfaceTexts = {
  header: {
    title: { es: 'Nuestra Sede de El Paso', en: 'Our El Paso Location' },
    subtitle: { 
      es: 'Información detallada, servicios y el equipo legal a su disposición en El Paso, TX.', 
      en: 'Detailed information, services, and the legal team at your disposal in El Paso, TX.' 
    },
  },
  contact: {
...
// --- DATA ESPECÍFICA DE EL PASO ---
const elPasoData: OfficeData = {
  id: 'el-paso',
  city: 'El Paso',
  state: 'TX',
...
// --- COMPONENTE DE PÁGINA ESPECÍFICO DE EL PASO ---
export default function ElPasoOfficePage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [isVideoLoaded, setIsVideoLoaded] = useState(false);
  
  const activeOffice = elPasoData;
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
            ...
            <section className="w-full bg-white pt-24 md:pt-32 pb-20 overflow-x-hidden" id='el-paso-office'>
